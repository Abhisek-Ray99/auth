...
const Login = ({
  ...
  return (
    <View style={{
      ...
      <CustomComponent.TextView title={'Please sign-in to your account'} textStyle={[fonts.heading,{
      ...
      <View style={{
        ...
        <View style={{
          ...
          <CustomComponent.InputField
            ...
            />
            <CustomComponent.TextView textStyle={{
              paddingBottom: 20, color: colors.secondary, alignSelf: 'flex-end'
            ...
            <CustomComponent.AppButton
             ...
             <View style={{
              ...
              justifyContent: 'center'
                ...
                <Text style={{color: colors.light}}>{`New to our platform? `}</Text>
